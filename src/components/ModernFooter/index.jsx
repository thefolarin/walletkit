      ...
      <div class="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto space-y-6">
          <div class="flex justify-center space-x-6">
            ...
            <div
              class="text-gray-50 hover:text-opacity-75"
              aria-label="GitHub"
            >
              <svg
                class="w-8 h-8"
          ...
          <nav class="relative flex flex-wrap justify-center gap-8 p-8 text-sm font-bold border-4 border-green-500 rounded-xl">
            ...
            <p class="hover:opacity-75 text-gray-50 cursor-pointer">Discord</p>

            <p class="hover:opacity-75 text-gray-50 cursor-pointer">Whatsapp</p>
          </nav>
